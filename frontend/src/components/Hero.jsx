...
// import profileImg from "../assets/princeImg-01.png";

// export default function Hero() {
//   return (
//     <section
//       id="home"
//       className="min-h-screen flex items-center pt-28 overflow-hidden"
//     >
...
//         >
//           <p className="inline-flex gap-2 items-center px-4 py-2 rounded-full bg-sky-400/10 text-sky-300 border border-sky-400/20 mb-6">
//             <MapPin size={16} />
//             {profile.location}
//           </p>
...
//           <h2 className="text-2xl sm:text-4xl mt-4 font-bold text-slate-200">
//             {profile.role}
//           </h2>
...
//         >
//           <div className="absolute top-8 right-0 w-72 h-72 sm:w-96 sm:h-96 bg-sky-500/20 blur-3xl rounded-full"></div>

//           <div className="relative flex justify-center">
//             <img
//               src={profileImg}
//               alt="Prince Kumar"
//               className="w-72 h-72 sm:w-96 sm:h-96 lg:w-[420px] lg:h-[420px] object-cover rounded-full border-4 border-sky-500 shadow-2xl"
//             />
//           </div>

//           <div className="relative grid grid-cols-3 gap-3 mt-6 w-full max-w-md">
//             <div className="card p-4 text-center">
//               <b className="text-xl text-white">2+</b>
//               <p className="text-xs text-slate-400 mt-1">Projects</p>
//             </div>

//             <div className="card p-4 text-center">
//               <b className="text-xl text-white">3mo</b>
//               <p className="text-xs text-slate-400 mt-1">Internship</p>
//             </div>

//             <div className="card p-4 text-center">
//               <b className="text-xl text-white">250+</b>
//               <p className="text-xs text-slate-400 mt-1">Problems</p>
//             </div>
//           </div>
//         </motion.div>
//       </div>
